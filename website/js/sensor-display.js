// Configuration
const TEMPERATURE_LIVINGROOM_URL = 'json/temperature_livingroom.json';
const TEMPERATURE_BEDROOM_URL = 'json/temperature_bedroom.json';
const HUMIDITY_LIVINGROOM_URL = 'json/humidity_livingroom.json';
const HUMIDITY_BEDROOM_URL = 'json/humidity_bedroom.json';
